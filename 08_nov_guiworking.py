...
# Create a "Read All" button to Receive start time and on duration valve data from Modbus
read_all_button = tk.Button(button_frame, text="Read All", command=read_valve_data, font=("Helvetica", 14))
read_all_button.grid(row=0, column=0, padx=10)
