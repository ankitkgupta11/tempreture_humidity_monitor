...
def create_edit_menu():
    ...
    baud_rate_menu = Menu(edit_menu, tearoff=0)
    baud_rate_menu.add_radiobutton(label="9600", variable=selected_baud_rate, value="9600")
    baud_rate_menu.add_radiobutton(label="4800", variable=selected_baud_rate, value="4800")
    edit_menu.add_cascade(label="Baud Rate", menu=baud_rate_menu)

    # Allow user input for Slave ID
